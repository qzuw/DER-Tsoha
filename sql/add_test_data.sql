...
INSERT INTO Paivakirja (partahoyla_id, aggressiivisuus, kayttaja_id, tera_id, teravyys, pehmeys, pvm, saippua, kommentit, julkisuus) VALUES (1, 4, 1, 1, 4, 4, '2016-04-14 18:00:00', 'MWF', 'Hyvä ajo, vakiokombo Parker, Astra ja MWF ei taaskaan pettänyt. Ajon viimeisteli Nivean aftershave-balsami.', TRUE);
INSERT INTO Paivakirja (partahoyla_id, aggressiivisuus, kayttaja_id, tera_id, teravyys, pehmeys, pvm, saippua, kommentit, julkisuus) VALUES (4, 5, 1, 1, 5, 4, '2016-06-14 19:00:00', 'MWF', 'Huolimatta MWN tarjoamasta suojasta, veri virtasi vuolaasti. Paikkailin haavoja alunalla.', FALSE);
INSERT INTO Paivakirja (partahoyla_id, aggressiivisuus, kayttaja_id, tera_id, teravyys, pehmeys, pvm, saippua, kommentit, julkisuus) VALUES (1, 4, 2, 1, 4, 4, '2016-06-12 21:00:00', 'LEA Classic-voide', 'Perusajo Parkerilla ja Astralla. LEA ei ehkä ole liukkain mahdollinen, mutta mukava tuoksu. Ajon viimeisteli jälleen Nivean aftershave-balsami.', TRUE);
